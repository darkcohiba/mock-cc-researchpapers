...
class Research(db.Model, SerializerMixin):
    ...
    authors = db.relationship("Author", secondary="research_authors", back_populates="researches", cascade = 'all, delete')
...
class Author(db.Model, SerializerMixin):
    ...
    created_at = db.Column(db.DateTime, server_default=db.func.now())
    updated_at = db.Column(db.DateTime, onupdate=db.func.now())
    researches = db.relationship("Research", secondary="research_authors", back_populates="authors", cascade = 'all, delete')
